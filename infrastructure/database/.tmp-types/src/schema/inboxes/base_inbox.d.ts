...
declare const inboxBaseColumns: {
  id: import("drizzle-orm").HasDefault<
    import("drizzle-orm").IsPrimaryKey<
      import("drizzle-orm").NotNull<
        import("drizzle-orm/pg-core").PgUUIDBuilderInitial<"id">
      >
    >
  >;
  requestId: import("drizzle-orm").NotNull<
    import("drizzle-orm/pg-core").PgTextBuilderInitial<
      "request_id",
      [string, ...string[]]
    >
  >;
  idempotencyKey: import("drizzle-orm").NotNull<
    import("drizzle-orm/pg-core").PgTextBuilderInitial<
      "idempotency_key",
      [string, ...string[]]
    >
...
export declare const createInboxTable: <
  TTableName extends string,
  TColumnsMap extends Record<string, PgColumnBuilderBase>,
>(
  name: TTableName,
...
) => InboxTable<TTableName, TColumnsMap>;
export {};
