...
declare const DatabaseError_base: new <A extends Record<string, any> = {}>(
...
declare const Database_base: Context.TagClass<
  Database,
  "sappho/Database",
  DatabaseService
>;
export declare class Database extends Database_base {}
export declare const DatabaseLive: Layer.Layer<
  Database,
