...
CREATE UNIQUE INDEX "orders_clover_order_id_uidx" ON "fcv_orders" USING btree ("clover_order_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "order_payments_order_id_clover_payment_id_uidx" ON "fcv_order_payments" USING btree ("order_id","clover_payment_id");
